...
<div id="right-panel" class="right-panel">
    ...
    <div {if CommandeTable::getMessageSucces() neq ''} class="alert alert-success" role="alert"{/if}>
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                {foreach from=$listeCommandes item=commande}
                                    ...
                                    <tr>
                                        <td>{$ccommande->getNumero()}</td>
                                        <td>{$ccommande->getcodev()}</td>
                                        <td>{$ccommande->getCodec()}</td>
                                        <td>{$ccommande->getDateLivraion()}</td>
                                        <td>{$ccommande->getDateCommande()}</td>
                                        <td>{$ccommande->getTotalHt()}</td>
                                        <td>{$ccommande->getTotalTva()}</td>
                                        <td>{$ccommande->getEtat()}</td>
