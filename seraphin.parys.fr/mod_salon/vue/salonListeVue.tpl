...
<div id="right-panel" class="right-panel">
    ...
    <div {if SalonTable::getMessageSucces() neq ''} class="alert alert-success" role="alert"{/if}>
        {SalonTable::getMessageSucces()}
    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                {foreach from=$listeSalon item=salon}

                                    <tr>
                                        <td>{$salon->getCodes()}</td>
                                        <td>{$salon->getNom()}</td>
                                        <td>{$salon->getVille()}</td>
                                        <td>{$salon->getTelephone()}</td>
                                        <td>{$salon->getDatedebut()}</td>
                                        <td>{$salon->getDatefin()}</td>
                                        <td class="pos-actions">
                                            <form method="POST" action="index.php">
                                                <input type="hidden" name="gestion" value="salon">
                                                <input type="hidden" name="action" value="form_consulter">
                                                <input type="hidden" name="codes" value="{$salon->getCodes()}">
