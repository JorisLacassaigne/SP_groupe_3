...
<div id="right-panel" class="right-panel">
    ...
    <div {if ServiceTable::getMessageSucces() neq ''} class="alert alert-success" role="alert"{/if}>
        {ServiceTable::getMessageSucces()}
    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                {foreach from=$listeServices item=service}

                                    <tr>
                                        <td>{$service->getCodes()}</td>
                                        ...
                                        <td class="pos-actions">
                                            <form method="POST" action="index.php">
                                                ...
                                                <input type="hidden" name="codes" value="{$service->getCodes()}">
