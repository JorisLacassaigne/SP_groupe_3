...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 04 avr. 2024 à 12:13
...
--
-- Base de données : `seraphinparysfilrouge_1`
--
...
(61, 'Renaud Olivier', '8 rue de la république', '36000', 'Déols', ''),
(63, 'Didier Oui', '14 rue de l\'impasse', '87000', 'Ailleurs', '06 99 99 99 01');
...
CREATE TABLE `commande` (
  `numero` int NOT NULL COMMENT 'Num?ro de la commande',
...
CREATE TABLE `produit` (
  ...
  `poids_piece` int DEFAULT '0' COMMENT 'Poids d''une pièce en grammes pour les articles vendus par pièce'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
--
ALTER TABLE `vendeur`
  MODIFY `codev` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant du vendeur', AUTO_INCREMENT=19;
